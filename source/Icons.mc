...
module Icons{
	...
	function codesBig200(){
		//Thunderstorm
		return {"200d" => Rez.Drawables.Big_200d,
	...
	function codesBig300(){
		//Drizzle
		return {"300d" => Rez.Drawables.Big_300d,
	...
	function codesBig500(){
		//Rain
		return {"500d" => Rez.Drawables.Big_500d,
	...
	function codesBig600(){
		//Snow
		return {"600d" => Rez.Drawables.Big_600d,
	...
	function codesBig700(){
		//Atmosphere
		return {"701d" => Rez.Drawables.Big_701d,
	...
	function codesBig800(){
		//Cloud
		return {"800d" => Rez.Drawables.Big_800d,
	...
	function codesSmall200(){
		//Thunderstorm
		return {"200d" => Rez.Drawables.Small_200d,
	...
	function codesSmall300(){
		//Drizzle
		return {"300d" => Rez.Drawables.Small_300d,
	...
	function codesSmall500(){
		//Rain
		return {"500d" => Rez.Drawables.Small_500d,
	...
	function codesSmall600(){
		//Snow
		return {"600d" => Rez.Drawables.Small_600d,
	...
	function codesSmall700(){
		//Atmosphere
		return {"701d" => Rez.Drawables.Small_701d,
	...
	function codesSmall800(){
		//Cloud
		return {"800d" => Rez.Drawables.Small_800d,
